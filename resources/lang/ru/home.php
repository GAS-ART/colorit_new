...
return [
   ...
   'portfolio' => [
      ...
      'slides' => [
         ...
         '2' => [
            ...
            'text' => 'Объемные буквы для клиники Marista в Барселоне. Буквы выполененны из пвх материала с обклейкой. С дополнительным вставками золотого зеркального алюминия',
            'term' => '1,5 недели',
         ],
         '3' => [
            'title' => 'Вывеска для ресторана Terraza в Барселоне',
            'text' => 'Изготовление вывески с объемными буквами. Обьем букв 3,5 см. Обклеенные виниловой пленкой. Внутренняя подсветка с теплым свечением',
            'term' => '2,5 недели',
         ],
         '4' => [
            'title' => 'Световая вывеска для Olga Belmonte',
            'text' => 'Вывеска для салона красоты в Барселоне Olga Belmonte. Короб выполнен из черного 3 мм композита. 25 мм объемные буквы с внутренним свечение и накладками.',
            'term' => '3 недели',
         ],
         '5' => [
   ...
   'video' => [
      'title' => 'Взгляните на <span>процесс изготовления</span> букв и конструкции изнутри',
      'list' => [
