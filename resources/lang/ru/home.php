   ...
   'portfolio' => [
      ...
      'slides' => [
         ...
         '10' => [
            ...
            'text' => 'Вывеска для ивент агентства Butterfly Sant Cugat. Основа короб из композита. Монтированны объемные буквы 19 мм с подсветкой контражур',
            'term' => '2,5 недели',
         ],
         '11' => [
         ...
         '13' => [
            ...
            'text' => 'Наружная вывеска для магазина одежды Uniformes. Короб выполнен из 3мм композита с уф печатью. объемные буквы 3 см с подсветкой контражур. Свечение нейтральное',
            'term' => '2 недели ',
         ],
         '14' => [
            'title' => '',
