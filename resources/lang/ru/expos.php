...
return [
   'brandwall'=>[
      ...
      'content_after_image' => '<h3>Конструкция из металлических хронированных труб</h3> Tакже широко применяется в бизнесе для продвижения своих товаров и услуг. Это простая и популярная конструкция, которая часто используется на выставках, конференциях, презентациях, ярмарках, в магазинах и других местах, где необходимо привлечь внимание к бренду или продукту. Конструкция имеет прямоугольную или квадратную форму , что обеспечивает ей стабильность и прочность. Она легкая и портативная, легко собирается и разбирается. Большой плюс конструкции в том, что у нее есть металлические ножки обеспечивающие устойчивость даже на улице при небольшом ветре. У конструкции полотном является баннер, что дает прочностью и яркость изображения.<div class="size"Идет в размерах 200x200, 300x200 и другие.<div>',
      'aluminum' => [
         'title' => '',
         'text' => '',
         'image_titles' => [
