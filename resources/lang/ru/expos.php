...
return [
   ...
   'banner'=>[
      ...
      'examples' => [
         'title' => '',
         'text' => '<h3>Баннеры Frontlit</h3> <div class="text">Обеспечивают высококачественную и яркую передачу графики и цветов. Эти баннеры изготавливаются из прочных и долговечных материалов, которые устойчивы к влажности, солнечному свету и ветру. Они могут использоваться как на улице, так и внутри помещений. Баннеры Frontlit легко складывать и транспортировать, что удобно для перевозки на мероприятия и монтажа на месте. Крепятся баннеры на конструкции с помощью металических колец – люверсов.</div>',
         'image_titles' => [
         '1' => '',
         'alt_1' => '',
         '2' => '',
