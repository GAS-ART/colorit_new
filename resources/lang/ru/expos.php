...
return [
  ...
  'stands'=>[
   ...
   'text' => 'Добро пожаловать в мир возможностей, где каждая выставка становится событием, а каждый стенд - произведением искусства. Выставочный стенд - это специально созданная конструкция для представления вашей компании, продукции или услуг на выставках и мероприятиях. Это важный инструмент для привлечения внимания и взаимодействия с посетителями. Он включает в себя:
    <br><br><b>Дизайн и графика:</b> Визуальное оформление стенда, отражающее бренд и ценности компании.
    <br><br><b>Структура:</b> Основа стенда, определяющая его форму и функциональность.
    <br><br><b>Интерактивные элементы:</b> Сенсорные экраны, игры и другие элементы для вовлечения посетителей.
    <br><br><b>Оборудование:</b> Мониторы, образцы продукции и техническое оборудование.
    <br><br><b>Освещение:</b> Качественное освещение для привлекательности стенда.
    <br><br><b>Мебель и аксессуары:</b> Столы, стулья и другие элементы для комфорта посетителей.
    <br><br><b>Информационные материалы:</b> Брошюры и печатные материалы.
    <br><br><b>Презентационные области:</b> Зоны для презентаций и демонстраций.
    <br><br><b>Логистика и монтаж:</b> Планирование и монтаж стенда на месте мероприятия.
    ...
    'types' => [
      ...
      'image_titles' => [
        '1' => 'Модульные стенды',
        'alt_1' => 'Выставочные модульные стенды под заказ под ивенты и мероприятия. Изготовление, доставка, установка. По всей Испании',
        '2' => 'Стандартный стенды',
        'alt_2' => 'Стенды для выставок, ивентов, презентаций. Изготовление в Барселоне',
        '3' => 'Промо стенды',
        'alt_3' => 'Изготовление промо стендов, промостоек на выставки и мероприятия. Изготовление и установка по Барселоне и Испании',
        '4' => 'Эксклюзивные стенды',
        'alt_4' => 'Выставочные стенды. Промостойки. Изготовление эксклюзивных выставочных стендов в Барселоне и Испании',
      ],
    ],
    'service' => [
      'title' => 'Услуги',
    ...
    <br><br>Наши Принципы:
    <br><br>Индивидуальный Подход: Мы верим, что каждый бренд уникален, и поэтому наши стенды создаются с учетом ваших целей, аудитории и брендовой идентичности.
    <br><br>Инновации и Технологии: Мы всегда в поиске новых технологий и тенденций в дизайне выставочных стендов. Мы интегрируем интерактивные элементы, мультимедийные решения и современные материалы, чтобы ваш стенд выделялся среди конкурентов.
    <br><br>Качество и Сроки: Мы гордимся высоким качеством нашей работы и соблюдаем сроки проектов. Мы стремимся к тому, чтобы каждый стенд был идеальным визуальным и функциональным решением.
    <br><br>Команда Профессионалов: Наша команда состоит из специалистов с многолетним опытом в индустрии выставочного маркетинга. Мы готовы принимать вызовы любой сложности.
    <br><br>Наши Услуги:
    <br><br>Дизайн и концепция стенда
    ...
    <br><br>Выберите нас в качестве вашего надежного партнера в создании выставочных стендов, и давайте вместе сделаем ваш следующий выставочный опыт неповторимым',
  ],
]
