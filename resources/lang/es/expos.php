...
return [
  ...
  'stands' => [
    'photo' => [
      1 => [
        'name' => 'diseno-y-montaje-de-stands-para-ferias',
        'alt' => 'Stand de exposición de gran formato con letras luminosas y zona de presentación en la feria EXPO 2024',
      ],
      'cost' => [
        'name' => 'elementos-espectaculares-para-exposiciones-y-eventos',
        'alt' => 'Espectacular stand de exposición con letras luminosas gigantes Innovate 2024 y zona de presentaciones para eventos',
      ],
      'for_exhibitions' => [
        1 => [
          'name' => 'fabricacion-letras-corporeas-y-logotipos-grandes',
          'alt' => 'Letras corpóreas grandes y logotipo 3D luminoso de Davinci Clinique en la fachada',
        ],
        2 => [
          'name' => 'fabricacion-estructuras-luminosas-y-letras-led',
          'alt' => 'Fabricación de estructura luminosa en forma de gran letra LED verde para iluminación de marca',
        ],
        3 => [
          'name' => 'diseno-y-montaje-de-stands-interactivos-para-ferias',
          'alt' => 'Enorme stand de exposición interactivo de 1XBET en forma de pinball con iluminación LED dinámica',
        ],
        4 => [
          'name' => 'construccion-de-podios-y-tarimas-para-presentaciones',
          'alt' => 'Elegante podio de exposición de la marca EVA con pantallas para presentación de productos',
        ],
        5 => [
          'name' => 'diseno-de-photocalls-y-espacios-de-marca-para-eventos',
          'alt' => 'Photocall exclusivo de la marca BGaming con letra corpórea grande, cortinas y velas',
        ],
      ],
      'projects' => [
        1 => [
          'name' => 'logotipo-corporeo-y-letras-caixabank',
          'alt' => 'Proyecto realizado: letras corpóreas grandes y logotipo para el banco CaixaBank',
          'title' => 'Stands interactivos',
          'text' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
        ],
        2 => [
          'name' => 'totem-informativo-metalico-para-eventos',
          'alt' => 'Proyecto realizado: tótem informativo metálico de forma cilíndrica para eventos',
          'title' => 'Stands interactivos',
          'text' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
        ],
        3 => [
          'name' => 'podio-de-exposicion-con-pantallas-eva',
          'alt' => 'Proyecto realizado: podio de exposición con pantallas de presentación para la marca EVA',
          'title' => 'Stands interactivos',
          'text' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
        ],
        4 => [
          'name' => 'decoracion-de-photocall-bgaming',
          'alt' => 'Proyecto realizado: decoración exclusiva de photocall para la marca BGaming',
          'title' => 'Stands interactivos',
          'text' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
        ],
        5 => [
          'name' => 'letrero-corporeo-de-pie-mobile-world-capital',
          'alt' => 'Proyecto realizado: letrero corpóreo de pie para Mobile World Capital Barcelona',
          'title' => 'Stands interactivos',
          'text' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
        ],
        6 => [
          'name' => 'stand-de-exposicion-interactivo-pinball-1xbet',
          'alt' => 'Proyecto realizado: stand de exposición interactivo en forma de pinball para 1XBET',
          'title' => 'Stands interactivos',
          'text' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
        ],
        7 => [
          'name' => 'letra-led-luminosa-color-verde',
          'alt' => 'Proyecto realizado: letra LED luminosa en 3D de color verde',
          'title' => 'Stands interactivos',
          'text' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
        ],
        8 => [
          'name' => 'letras-corporeas-de-acrilico-azul-1x',
          'alt' => 'Proyecto realizado: letras corpóreas brillantes de acrílico azul 1X',
          'title' => 'Stands interactivos',
          'text' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
        ],
        9 => [
          'name' => 'rotulo-exterior-iluminado-cervello',
          'alt' => 'Proyecto realizado: rótulo exterior iluminado a ras de suelo para Cervello Natura',
          'title' => 'Stands interactivos',
          'text' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.',
        ],
      ],
      'proposition' => [
        'name' => 'decoracion-de-stands-para-ferias-y-eventos',
        'alt' => 'Stand de exposición moderno con letras corpóreas luminosas TECHNOVA diseñadas para destacar en ferias y eventos',
      ],
    ],
    'banner' => [
      ...
      'categories' => [
        '1' => 'Podios',
        '2' => 'Estructuras luminosas',
        '3' => 'Photocalls',
        '4' => 'Letras corpóreas',
      ],
    ],
    'for_exhibitions' => [
      'title' => 'Qué producimos para exposiciones',
      'text' => '<p>Nos especializamos en la producción de elementos visuales que mejoran un stand de exposición y hacen que la marca sea más visible.</p><p>También desarrollamos y producimos stands interactivos que atraen la atención de los visitantes y aumentan el compromiso.</p>',
      'cards' => [
        1 => [
          'title' => 'Letras corpóreas',
          'text' => 'Logotipos y letras grandes para stands y eventos.',
        ],
        2 => [
          'title' => 'Estructuras luminosas',
          'text' => 'Letras LED, paneles luminosos e iluminación de marca.',
        ],
        3 => [
          'title' => 'Stands interactivos',
          'text' => 'Logotipos y letras grandes para stands y eventos.',
        ...
        4 => [
          'title' => 'Podios',
          'text' => 'Estructuras para presentación de productos y exhibiciones.',
        ],
        5 => [
          'title' => 'Photocalls',
          'text' => 'Espacios de marca para eventos.',
        ],
      ],
    ],
    'projects' => [
    ...
    'why' => [
      [
        ...
        'text' => 'Trabajamos con publicidad exterior y exposiciones.',
      ],
      [
        'title' => 'Producción propia',
        'text' => 'Control de calidad en cada etapa.',
      ],
      [
        'title' => 'Cumplimiento de plazos',
        'text' => 'Entendemos la especificidad de las exposiciones.',
      ],
      [
        'title' => 'Instalación llave en mano',
        'text' => 'Nos encargamos de la instalación de las estructuras.',
      ],
    ],
    'work' => [
      ...
      'cards' => [
        1 => [
          'number' => '1',
          'text' => 'Discusión del proyecto',
        ],
        2 => [
          'number' => '2',
          'text' => 'Preparación de la propuesta',
        ],
        3 => [
          'number' => '3',
          'text' => 'Producción',
    ...
    'proposition' => [
      'title' => '¿Planean participar en una exposición?',
      'subtitle' => 'Les ayudaremos a crear elementos que harán destacar su stand.<br><br> Envíe su solicitud ahora — prepararemos su propuesta en 24 horas.',
      'btn1' => 'Obtener cálculo del proyecto',
      'btn2' => 'Escribir por Whatsapp',
      'footnote' => '',
    ],
    'text_title' => '¿Qué es un stand de feria?',
    ...
    'advantages' => [
      '1' => [
        'title' => 'Fabricación en Barcelona',
        'text' => 'Todas las estructuras se fabrican en nuestras propias instalaciones en Barcelona, utilizando tecnologías modernas y materiales de calidad.',
      ],
      '2' => [
        'title' => 'Fabricación a partir de 7 días',
        'text' => 'Fabricamos elementos para exposiciones y eventos en un plazo a partir de 7 días, cumpliendo con los requisitos técnicos precisos del proyecto.',
      ],
      '3' => [
        'title' => 'Montaje en toda España',
        'text' => 'Nuestro equipo realiza el montaje profesional de estructuras en exposiciones y eventos en todo el territorio de España.',
      ],
    ],
    'cost' => [
