...
return [
  ...
  'side_box' => [
    ...
    'lead' => [
      'title' => 'Deja una solicitud para tu banderola luminosa',
    ],
    'questions' => [
      '1' => [
    ...
    'about_text' => 'En el mundo minorista cada vez más competitivo de hoy, la creación de un entorno de tienda único y atractivo juega un papel importante para atraer y retener clientes. La caja de luz lateral es una herramienta que puede transformar tu tienda y crear una atmósfera visual única.<br>
    Las señales laterales luminosas tienen la capacidad única de llamar la atención incluso en calles comerciales concurridas. Destaca por su luz brillante, que inmediatamente atrae la atención de los transeúntes y clientes potenciales. Esto permite que tu tienda destaque del resto y cree una primera impresión que puede influir en la decisión de visitarla.<br>
    La señalización exterior es el arte del marketing visual. Le permite expresar la singularidad de su marca y crear un cierto estilo o atmósfera. Puede resaltar los colores y el logotipo de su empresa o incluso utilizar formas y efectos creativos para hacer que su tienda sea más atractiva y memorable.<br><br>
    Cuando los clientes ven su letrero, lo asocian instantáneamente con su marca. Esto puede ayudar a fidelizar a los clientes, ya que asociarán el letrero con experiencias y compras positivas.<br>
    Una caja de luz reversible no sólo atrae la atención durante el día, sino que también proporciona visibilidad nocturna a su tienda. Por la noche, se convierte en un punto de referencia luminoso que indica la ubicación de su tienda y crea una sensación de seguridad y comodidad para los clientes.<br>
    Una publicidad exterior atractiva puede animar a los transeúntes a entrar en su tienda incluso sin planes previos. Puede actuar como un imán, atrayendo gente y ayudando a aumentar el flujo de clientes. Por tanto, puede influir en los niveles de ventas y en el éxito empresarial general.<br>
    El rótulo lateral iluminado no es sólo una herramienta publicitaria, es una forma de crear una atmósfera única y atractiva en su tienda. Llama la atención, resalta la marca, aumenta las ventas y crea una experiencia inolvidable para los clientes. Al invertir en un letrero luminoso de calidad, está invirtiendo en el éxito de su negocio y en su reconocimiento ante los ojos de los clientes.',
  ],
  'neon' => [
    'banner' => [
      'title' => 'Neon',
