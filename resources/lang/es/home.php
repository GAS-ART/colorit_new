...
return [
   ...
   'reviews' => [
      ...
      'melanta' => [
         ...
         'name' => '<p>Anna salon de estetica <span>¨Melanta¨</span></p>',
      ],
      'duo' => [
         'text' => '<p>Es una suerte trabajar con profesionales. Muchas gracias por calidad, atención y trabajo. Un saludo.</p>',
      ...
      'kabakova' => [
         'text' => '<p>Buen trabajo e buen servicio! Recomiendo!</p> <p>Отличные и надежные ребята. Работа выполнено отлично и в срок! Рекомендую!</p>',
      ...
      'gas_auto' => [
         'text' => '<p>Hemos pedido las camisetas con logos personalizadas y todo esta hechos perfecto. Gracias!</p>',
         'name' => '<p>Tatiana <span>¨Gas Auto¨</span></p>',
      ],
      'estetica' => [
         'text' => '<p>Todo esta hecho con calidad. Los chicos han encontrado una resolución en una situación muy complicada para colocar el rotulo. Son profesionales en todas partes por eso les deseo mucha suerte en todo.</p>',
         'name' => '<p>Anna <span>¨Laboratorio de estetica¨</span></p>',
      ],
      'li_beauty' => [
         'text' => '<p>Trabajamos con Colorit agency tres años. Estamos muy contentos por todo lo que nos han hecho. Alta calidad de productos e servicio.</p>',
         'name' => '<p>Lidia <span>¨Li.Beauty Lounge¨</span></p>',
      ],
      'globos' => [
         'text' => '<p>Colaboramos con chicos de Colorit agency ya 1,5 años. Somos una agencia de decoracion de flores y globos para los eventos y por eso los pedidos son diferentes desde las tarjetas de visita hasta estructuras o figuras grandes y lonas de 42 metros y a menudo tenemos pedidos con urgencia. Los chicos siempre los aceptan y nos ayudan mucho. Todo siempre en tiempo, con calidad y atención Recomendable.</p>',
      ...
      'detailing' => [
         'text' => '<p>Todo con calidad e en tiempo. Querríamos decir muchas gracias por toda producción que nos hicieron.</p>',
   ...
   'reviews' => [
      ...
      'items' => [
         1 => [
            ...
            'date' => '2026-06-20',
            'text' => 'Excelente trabajo de rotulación en nuestra oficina. Desde el primer momento entendieron perfectamente lo que necesitábamos para reflejar nuestra identidad corporativa. Los acabados de los vinilos son impecables, con una colocación limpia y profesional.',
         ],
         2 => [
            'name' => 'Mc',
            'date' => '2026-06-20',
            'text' => 'Súper profesionales, atentos y muy eficientes. El resultado ha quedado perfecto y estoy muy contento. Los recomiendo al 100%',
         ],
         3 => [
            'name' => 'Marta Eri',
            'date' => '2026-02-20',
            'text' => 'Estoy encantada con el resultado. Un cartel precioso y muy original. Han tenido muy buena disposición y paciencia a la hora de atender todas mis sugerencias para elaborar el cartel. Muy recomendables.',
         ],
         4 => [
            'name' => 'Francys Vanegas',
            'date' => '2025-08-20',
            'text' => 'Me encantó trabajar con esta empresa porque hicieron un trabajo que era muy importante para mí como la fachada de mi negocio en tiempo RÉCORD! Fueron pacientes y muy rápidos! Muchas gracias Rótulos Colorit! Los recomendaría mil veces y los elegiría nuevamente para un futuro trabajo',
         ],
         5 => [
            'name' => 'Mikhail Baranov',
            'date' => '2025-07-20',
            'text' => 'Llevamos trabajando con el equipo ya 2 años, ningún problema, siempre todo a tiempo y con gran calidad. Si algo no sale bien, siempre lo solucionan sin problemas 😉 Los recomiendo a todos 👍🏻…',
         ],
         6 => [
            'name' => 'Andre On',
            'date' => '2025-07-20',
            'text' => 'Queremos expresar nuestro agradecimiento a su equipo por la creación del rótulo para nuestro local BAR 69. El resultado superó todas las expectativas: el rótulo quedó llamativo, elegante y encajó perfectamente con la atmósfera del bar. Gracias a él, la entrada se ha vuelto muy visible y atractiva para los clientes. Queremos destacar especialmente su rapidez, la atención a los detalles y el enfoque profesional en todas las etapas del trabajo, desde la selección de materiales hasta el montaje. Todo se realizó en el plazo acordado y con una calidad excelente. Recomendamos con total seguridad a su empresa como un socio de confianza y esperamos seguir colaborando en el futuro. Atentamente, el equipo de BAR 69',
         ],
         7 => [
            'name' => 'kir',
            'date' => '2025-07-20',
            'text' => '¡Una experiencia absolutamente increíble trabajando con Artyom y su equipo! Súper profesionales, rápidos, y la calidad del rótulo exterior y las letras de interior es de primera. Si estás en Barcelona y necesitas rótulos bien hechos, este es el lugar. ¡100% recomendables!',
         ],
         8 => [
            'name' => 'Svetlana Buņina',
            'date' => '2024-07-20',
            'text' => 'Recomiendo esta empresa para la fabricación de materiales para conferencias, eventos, tarjetas de visita, folletos, etc. Muy rápidos y eficientes. En ciertas situaciones (como pedidos de última hora para un evento) atienden el encargo y las peticiones con especial rapidez y calidad, algo que no tienen otras empresas del mercado. Los materiales siempre son de alta calidad y vienen perfectamente empaquetados para su posterior uso o almacenamiento. En caso de dudas sobre los productos, te asesoran y ofrecen soluciones.',
         ],
      ],
   ],
];
