...
return [
   ...
   'video' => [
      ...
      'list' => [
         ...
         '2' => 'Работаем качественно и 6 дней в неделю. Проэкты выполняем быстро и без задержек',
         '3' => 'Работаем качественно и 6 дней в неделю. Проэкты выполняем быстро и без задержек',
      ],
   ],
   'result' => [
      'title' => 'Взгляние на процесс изгтовление букв и контструкции изнутри',
   ],
]
